"""
Script to generate the complete, fully documented, and runnable Jupyter Notebook `experiment_pipeline.ipynb`.
"""
import json
...
with open("experiment_pipeline.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("Generated 'experiment_pipeline.ipynb' successfully.")
